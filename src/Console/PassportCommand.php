...
namespace Glocurrency\ApiLayer\Console;
...
class PassportCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'glo:apilayer:passport
    ...
    protected function configureUuids()
    {
        ...
        $this->replaceInFile(
            database_path('migrations/2016_06_01_000001_create_oauth_auth_codes_table.php'),
        ...
        $this->replaceInFile(
            database_path('migrations/2016_06_01_000002_create_oauth_access_tokens_table.php'),
            '$table->unsignedBigInteger(\'client_id\');',
            '$table->uuid(\'client_id\');'
        );
        $this->replaceInFile(
        ...
        $this->replaceInFile(
            database_path('migrations/2016_06_01_000004_create_oauth_clients_table.php'),
        ...
        $this->replaceInFile(
            database_path('migrations/2016_06_01_000005_create_oauth_personal_access_clients_table.php'),
            '$table->unsignedBigInteger(\'client_id\');',
            '$table->uuid(\'client_id\');'
        );
